...
import com.belak.shoppingcart.service.user.IUserService;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse> updateUer(@RequestBody UserUpdateRequest request,@PathVariable Long userId)
    {
        try {
